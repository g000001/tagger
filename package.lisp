...
(cl:defpackage :vector-resource
  ...
  (:export
   #:resource-type #:fixvref #:adjust-lfixv #:fill-sv #:fixnum-vector #:fill-sfv
   #:let-sfv #:clear-byte32v-storage #:sfv-length #:sfv #:sv #:alloc-lsv
   #:adjust-byte32v #:make-byte32v #:sfv-add #:fill-lsfv #:fixv #:adjust-lsfv
   #:alloc-lsfv #:adjust-lsv #:fill-fixv #:clear-fixv-storage #:byte32vref
   #:fill-lfixv #:adjust-fixv #:alloc-sfv #:let-byte32v #:let-sv #:sfv-max
   #:fill-lsv #:alloc-fixv #:fill-lbyte32v #:copy-byte32v #:free-byte32v #:lert*
   #:free-fixv #:lert #:sfv-div #:copy-sv #:byte32-vector #:alloc-lfixv #:sfvref
   #:make-sv #:copy-sfv #:let-fixv #:copy-fixv #:adjust-lbyte32v #:fixv-length
   #:free-sfv #:adjust-sv #:adjust-sfv #:byte32v-length #:fill-byte32v
   #:clear-sfv-storage #:clear-sv-storage #:make-fixv #:free-fn #:alloc-lbyte32v
   #:alloc-byte32v #:free-sv #:make-sfv #:byte32v #:alloc-sv #:sv-length
   #:single-float-vector)
